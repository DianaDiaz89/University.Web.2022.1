...
namespace University.Web.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartmentID,Name,Budget,StartDate,InstructorID")] DepartmenDTO departmentDTO)
        {
            ...
            ViewBag.InstructorID = new SelectList(db.Instructors, "ID", "LastName", departmentDTO.InstructorID);
